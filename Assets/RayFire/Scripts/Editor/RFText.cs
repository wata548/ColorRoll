...
namespace RayFireEditor
{
    ...
    public static class TextAct
    {
        ...
        public static readonly GUIContent gui_speed             = new GUIContent ("Speed",              "Objects will be activated if Activator object speed (m/s) is higher than this value. Disabled when 0.");
    ...
    public static class TextCnt
    {
        ...
        public static readonly GUIContent gui_dmg_cur         = new GUIContent ("Current Damage",  "");
        public static readonly GUIContent gui_dmg_max         = new GUIContent ("Maximum Damage",  "");
    ...
    /// <summary>
    /// Rayfire Defect text for GUI elements.
    /// </summary>
    public static class TextDfc
    {
        // Help
        public const string hlp_bake = "Mesh in Mesh Filter component is not referenced to mesh asset after Baking. \n" +
                                       "Export to mesh asset in order to save object as prefab.";
        
        // GUI content
        public static readonly GUIContent gui_emp         = new GUIContent("");
        public static readonly GUIContent gui_reset       = new GUIContent("  Reset");
        public static readonly GUIContent gui_source      = new GUIContent("Source");
        public static readonly GUIContent gui_seed        = new GUIContent ("Seed");
        public static readonly GUIContent gui_mult        = new GUIContent ("Multiplier");
        public static readonly GUIContent gui_awake       = new GUIContent ("Apply in Awake");
        public static readonly GUIContent gui_lckX        = new GUIContent("Lock X");
        public static readonly GUIContent gui_lckY        = new GUIContent("Lock Y");
        public static readonly GUIContent gui_lckZ        = new GUIContent("Lock Z");
        public static readonly GUIContent gui_lck         = new GUIContent("Lock XYZ");
        public static readonly GUIContent gui_prp         = new GUIContent("Proportions");
        public static readonly GUIContent gui_min         = new GUIContent("Minimum");
        public static readonly GUIContent gui_max         = new GUIContent("Maximum");
        public static readonly GUIContent gui_tm          = new GUIContent("  Transform");
        public static readonly GUIContent gui_pos         = new GUIContent("Position");
        public static readonly GUIContent gui_posMinX     = new GUIContent("-X");
        public static readonly GUIContent gui_posMaxX     = new GUIContent("X");
        public static readonly GUIContent gui_posMinY     = new GUIContent("-Y");
        public static readonly GUIContent gui_posMaxY     = new GUIContent("Y");
        public static readonly GUIContent gui_posMinZ     = new GUIContent("-Z");
        public static readonly GUIContent gui_posMaxZ     = new GUIContent("Z");
        public static readonly GUIContent gui_rot         = new GUIContent("Rotation");
        public static readonly GUIContent gui_rotMinX     = new GUIContent("-X");
        public static readonly GUIContent gui_rotMaxX     = new GUIContent("X");
        public static readonly GUIContent gui_rotMinY     = new GUIContent("-Y");
        public static readonly GUIContent gui_rotMaxY     = new GUIContent("Y");
        public static readonly GUIContent gui_rotMinZ     = new GUIContent("-Z");
        public static readonly GUIContent gui_rotMaxZ     = new GUIContent("Z");
        public static readonly GUIContent gui_scl         = new GUIContent("Scale");
        public static readonly GUIContent gui_sclMinX     = new GUIContent("-X");
        public static readonly GUIContent gui_sclMaxX     = new GUIContent("X");
        public static readonly GUIContent gui_sclMinY     = new GUIContent("-Y");
        public static readonly GUIContent gui_sclMaxY     = new GUIContent("Y");
        public static readonly GUIContent gui_sclMinZ     = new GUIContent("-Z");
        public static readonly GUIContent gui_sclMaxZ     = new GUIContent("Z");
        public static readonly GUIContent gui_nse_apply   = new GUIContent("Apply Noise");
        public static readonly GUIContent gui_nse_noise   = new GUIContent("  Noise");
        public static readonly GUIContent gui_nse_enable  = new GUIContent("Enable");
        public static readonly GUIContent gui_nse_coords  = new GUIContent("Coords");
        public static readonly GUIContent gui_nse_axes    = new GUIContent("Axes");
        public static readonly GUIContent gui_nse_dim     = new GUIContent("Dimension");
        public static readonly GUIContent gui_nse_scale   = new GUIContent("Scale");
        public static readonly GUIContent gui_nse_octa    = new GUIContent("Octaves");
        public static readonly GUIContent gui_nse_pers    = new GUIContent("Persistence");
        public static readonly GUIContent gui_nse_lac     = new GUIContent("Lacunarity");
        public static readonly GUIContent gui_nse_norm    = new GUIContent("Normalize", "Linearly interpolate noise values to values between 0 and 1.");
        public static readonly GUIContent gui_nse_cap_min = new GUIContent("Min Cap",   "Set minimum cap for noise values.");
        public static readonly GUIContent gui_nse_cap_max = new GUIContent("Max Cap",   "Set maximum cap for noise values.");
        public static readonly GUIContent gui_nse_inv     = new GUIContent("Invert",    "Invert noise values.");
        public static readonly GUIContent gui_nse_rem     = new GUIContent("Remove",    "Deactivate/Activate fragments based on Min and Max Threshold values.");
        public static readonly GUIContent gui_nse_min     = new GUIContent("  Min Threshold");
        public static readonly GUIContent gui_nse_max     = new GUIContent("  Max Threshold");
    }
    ...
    public static class TextMan
    {
        ...
        const string tlp_dml_time = "Demolition time quota in seconds. Allows to prevent demolition at " +
    ...
    public static class TextSht
    {
        ...
        const string tlp_slice  = " Hybrid: Meshes with open edges will be cut over their surface and meshes with closed edges will be sliced to fragments with inner surface. Should be used for tree like objects. \n" +
                                  " Forced Cut: All meshes will be cut over their surface. \n" +
                                  " Forced Cap: All meshes will be sliced to fragments with inner surface where possible.";
        const string tlp_hierar = " Instantiate: Root object and all children with mesh will be instantiated, mesh and renderer components will be destroyed and objects will be used as root for fragments. \n" +
                                  " Copy: Root object and all children hierarchy will be created from scratch and will be used as roots for fragments. \n" +
        ...
        public static readonly GUIContent gui_mat_col         = new GUIContent ("Vertex Color",            "Set custom Vertex Color for all inner surface vertices.");
        public static readonly GUIContent gui_mat_uve         = new GUIContent ("UV Region",               "Set custom UV coordinate region for all inner surface triangles.");
        ...
        public static readonly GUIContent gui_adv_slice       = new GUIContent ("Slice Type",              tlp_slice);
        ...
        public static readonly GUIContent gui_aabb_cap        = new GUIContent ("  Partial Fragmentation", "");
        public static readonly GUIContent gui_aabb_en         = new GUIContent ("Enable",                  "Generate fragments only inside custom fragmentation bounding box.");
    ...
    /// <summary>
    /// Rayfire Shell text for GUI elements.
    /// </summary>
    public static class TextShl
    {
        // Buttons
        public static readonly GUIContent gui_btn_create = new GUIContent ("Create Shell",     "");

        // GUI
        public static readonly GUIContent gui_cap_prp     = new GUIContent ("  Properties",    "");
        public static readonly GUIContent gui_awakeCreate = new GUIContent ("Create on Awake", "Create Shell Object on Awake");
        public static readonly GUIContent gui_edges       = new GUIContent ("Bridge",          "");
        public static readonly GUIContent gui_thickness   = new GUIContent ("Thickness",       "");
        public static readonly GUIContent gui_material    = new GUIContent ("Material",        "");
        public static readonly GUIContent gui_cap_bake    = new GUIContent ("  Bake",          "");
        public static readonly GUIContent gui_mergeSub    = new GUIContent ("As Sub Mesh",     "");
        public static readonly GUIContent gui_awakeBake   = new GUIContent ("Bake on Awake",   "");
        public static readonly GUIContent gui_cap_exp     = new GUIContent ("  Export",        "");
        public static readonly GUIContent gui_cap_info    = new GUIContent ("  Info",          "");

        // Help
        public const string hlp_bake = "Mesh in Mesh Filter component will not be referenced to mesh asset anymore after Baking. \n" +
                                       "Export to mesh asset first in order to save object as prefab.";
    }
    ...
    public static class TextSnd
    {
        ...
        public static readonly GUIContent gui_snd_clip  = new GUIContent ("AudioClip",         "The AudioClip Asset played by the AudioSource");
