...
namespace RayFireEditor
{
    ...
    public class RayfireShatterEditor : Editor
    {
        ...
        void GUI_Material()
        {
            ...
            RFUI.PropertyField (sp_mat_uve_en, TextSht.gui_mat_uve);
    ...
    public class UvRegionEditor : EditorWindow
    {
        ...
        private void HandleResize()
        {
            for (int i = 0; i < resizeHandles.Length; i++)
            {
                ...
                var fmh_1514_73_638860445772218240 = Quaternion.identity; Vector3 newHandlePosition = Handles.FreeMoveHandle(pos, 10f, Vector2.zero, Handles.RectangleHandleCap);
                if (EditorGUI.EndChangeCheck())
                {
