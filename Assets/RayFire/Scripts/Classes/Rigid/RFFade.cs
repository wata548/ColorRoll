...
namespace RayFire
{
    ...
    public class RFFade
    {
        ...
        public static void FadeRigid (RayfireRigid scr)
        {
            ...
            // Add to manager fade cor
            RayfireMan.inst.AddToFadeCor (scr);
        }
        ...
        static void SimExclude (RayfireRigidRoot root, RFShard shard)
        {
            // Faded
            shard.fade = 3;
        ...
        // Exclude from simulation, fall under ground, destroy
        public static IEnumerator FallDownCor (RayfireRigid rigid)
        {
            // Activate inactive
        ...
        // Exclude from simulation, move under ground, destroy
        public static IEnumerator ScaleDownCor (RayfireRigid scr)
        {
        ...
        // Exclude from simulation, fall under ground, destroy
        public static IEnumerator MoveDownCor (RayfireRigid rigid)
        {
            // Stop simulation
            rigid.physics.rb.useGravity      = false;
            rigid.physics.rb.linearVelocity        = Vector3.zero;
        ...
        // Exclude from simulation, move under ground, destroy
        static IEnumerator MoveDownCor (RayfireRigidRoot root, RFShard shard)
        {
            // Stop simulation
